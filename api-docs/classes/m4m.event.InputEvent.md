[@meta4d/engine](../README.md) / [Exports](../modules.md) / [m4m](../modules/m4m.md) / [event](../modules/m4m.event.md) / InputEvent
...
- [EmitEnum\_key](m4m.event.InputEvent.md#emitenum_key)
- [EmitEnum\_point](m4m.event.InputEvent.md#emitenum_point)
- [On](m4m.event.InputEvent.md#on)
- [OnEnum\_key](m4m.event.InputEvent.md#onenum_key)
- [OnEnum\_point](m4m.event.InputEvent.md#onenum_point)
...
▸ **EmitEnum_point**(`event`, ...`args`): `void`
...
▸ **OnEnum_key**(`event`, `func`, `thisArg`): `void`
...
▸ **OnEnum_point**(`event`, `func`, `thisArg`): `void`
